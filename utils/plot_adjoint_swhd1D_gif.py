...
U = [np.load(f'{pm.out_path}/adjuu_{tidx:04}.npy') for tidx in range(0, steps, pm.plot_step)]
H = [np.load(f'{pm.out_path}/adjhh_{tidx:04}.npy') for tidx in range(0, steps, pm.plot_step)]
