...
! Global number of continuation points and derivative order.
      INTEGER, PARAMETER :: Cx = 0
      INTEGER, PARAMETER :: Cy = 0
      INTEGER, PARAMETER :: Cz = 34
      INTEGER, PARAMETER :: ox = 0
      INTEGER, PARAMETER :: oy = 0
      INTEGER, PARAMETER :: oz = 9
...
!=================================================================
  ...
  MODULE newtmod
      USE fprecision
      INTEGER :: n_dim_1d, n_max_newt, n_max, n_last, n_max_hook, kend_ph
