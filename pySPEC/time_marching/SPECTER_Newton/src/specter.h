...
#define NEWT_ 
#define BOUSS_EVOL_ STRINGIFY(INCLUDEFNAME_)evol_T.f90'
#define BOUSS_PROJ_ STRINGIFY(INCLUDEFNAME_)sol_project.f90'
#define BOUSS_DERIV_ STRINGIFY(INCLUDEFNAME_)deriv.f90'
#endif